...
- Separate web admin service with browser-based GoBiz OTP setup and encrypted runtime gateway settings.
...
- Admin interactions use self-hosted CSP-compatible Alpine.js, and Compose persistence uses a named volume instead of a host bind mount.
